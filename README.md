...
This is a 2D forward looking sonar simulator built in Blender. Inspired by Cerqueira et al., we notice that an acoustic image can be generated by a backscattered intensity image and a depth (range) image. Although it is difficult to consider all the physical problems without modification of the render engine, for most of the cases the images from Blender statisfy our tasks like generating dataset to test learning-based or SLAM algorithms.  

![sim_13](https://user-images.githubusercontent.com/11170161/178510556-6dcf293f-1acd-4a62-a945-09d0922f1e46.png)
![real_13](https://user-images.githubusercontent.com/11170161/178510276-ecbab922-41bc-4ab2-ac50-9d31e1501fbf.png)
